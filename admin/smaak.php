...
$stmt = $conn->prepare("SELECT id, name, image FROM smaak WHERE enabled = 1 ORDER BY ID ASC");
$stmt->execute();
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="smaak.php">Smaak</a>
                    </li>
    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header">
                <button class='btn btn-sm btn-secondary float-end' type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Smaak Aanmaken</button>
                Smaak Opties
            </div>
            <div class="card-body">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach ($smaak as $item) {
                            echo '<tr><th scope="row">' . $item['id'] . '</th><td>' . $item['name'] . '</td><td><img class="img-fluid w-25" src="../images/smaaken/' . $item['image'] . '"></td><td><a href="../php/removesmaak.php?id=' . $item['id'] . '" class="btn btn-danger">Verwijderen</a></td></tr>';
                        } ?>
                    </tbody>
                </table>
            </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="../php/createsmaak.php" enctype="multipart/form-data">
